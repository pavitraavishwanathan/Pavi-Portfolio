        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          <div className="animate__animated animate__fadeInUp animate__delay-3s">
            <div className="flex items-center gap-3 mb-6 bg bg-zinc-800 w-fit p-4 rounded-2xl">
              <img src="./assets/panda.png" className="w-10 rounded-md" />
              <q>Avoid or just undertake it</q>
            </div>
            <h1 className="text-5xl font-bold mb-6">
              <ShinyText text="Hi I'm Pavitraa V" disabled={false} speed={3} className='custom-class' />
            </h1>
            <BlurText
              text="An Artificial Intelligence & Machine Learning student with a strong interest in Data Science, passionate about building intelligent systems, analyzing data, and developing machine learning solutions to solve real-world problems."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
            ...
            <div className="flex items-center sm:gap-4 gap-2">
              <a 
                href="./assets/Pavitraa_CV.pdf" 
                download="Pavitraa_CV.pdf" 
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <div className="basis-full md:basis-7/12 pr-0 md:pr-8 border-b md:border-b-0 md:border-r border-violet-500/30">
              ...
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="I am Pavitraa V, an Artificial Intelligence and Machine Learning student at Sir M Visvesvaraya Institute of Technology (VTU), Bangalore.I am passionate about Data Science, Machine Learning, and Artificial Intelligence.I enjoy working with data, building machine learning models, and developing intelligent systems that solve real-world problems. My interests include Data Analysis, Computer Vision, Natural Language Processing,and developing AI-powered applications."
                  delay={60}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-between text-center sm:text-left gap-y-8 sm:gap-y-0 mb-4 w-full">
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-2xl md:text-3xl mb-1">
                      8.3<span className="text-violet-500">/10.0</span>
                    </h1>
                    <p>CGPA</p>
                  </div>
                </div>
        ...
        <div className="kontak mt-32 sm:p-10 p-0" id="contact">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <form
                action="https://formsubmit.co/pavivishy14@gmail.com"
                method="POST"
